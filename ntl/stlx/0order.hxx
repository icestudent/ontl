/**\file*********************************************************************
 *                                                                     \brief
 *  This file used for doxygen only to sort the group names
 *
 ****************************************************************************
 */
...
\defgroup  lib_bind ***************** 20.7.11 Function template bind [bind]
...
\defgroup  lib_uniqueptr ********** 20.8.11 Class template unique_ptr (legacy) [unique.ptr]
\defgroup  lib_uniqueptr_rv ******* 20.8.11 Class template unique_ptr [unique.ptr]
