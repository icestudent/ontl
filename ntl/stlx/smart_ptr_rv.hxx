...
namespace std
{
  ...
  *@{*/
  /**\defgroup  lib_uniqueptr_rv ********** 20.7.11 Class template unique_ptr [unique.ptr] ***
  *@{*/

  /// 20.7.11 Class template unique_ptr [unique.ptr]

  /// 20.7.11.1 Default deleters [unique.ptr.dltr]
  ...
  /**\defgroup  lib_smartptr_rv *************** 20.7.12 Smart pointers [util.smartptr] *
  *@{*/
