 ...
 ****************************************************************************
 */
#ifndef NTL__STLX_TR2_NETWORK_RAWSOCKETSERVICE
#define NTL__STLX_TR2_NETWORK_RAWSOCKETSERVICE
#pragma once
...
namespace std { namespace tr2 { namespace network {
  ...
  /**
   *  @brief Class template raw_socket_service
   *
   *  Default service implementation for a raw sockets.
   **/
  ...
  public:
    ...
    ///\name constructors:
    explicit raw_socket_service(tr2::sys::io_service& ios)
      :service(ios), svc(ios)
    {}
...
#endif // NTL__STLX_TR2_NETWORK_RAWSOCKETSERVICE
