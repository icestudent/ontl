...
inline void NTL_CRTCALL srand(unsigned int seed)
{
...
__noalias void* __restrict  NTL_CRTCALL calloc(size_t nmemb, size_t size);
...
NTL_EXTERNAPI void * NTL_CRTIMP
  bsearch(const void *key, const void *base, size_t nmemb, size_t size,
              int (NTL_CRTIMP *compar)(const void *, const void *));
...
NTL_EXTERNAPI int NTL_CRTIMP mbtowc(wchar_t * __restrict pwc, const char * __restrict s, size_t n);

/// 7.20.7.3 The wctomb function
NTL_EXTERNAPI int NTL_CRTIMP wctomb(char *s, wchar_t wc);
